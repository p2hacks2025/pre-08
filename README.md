...
サイトに移動後、スタートボタンまたは画面タップでゲーム開始。彦星をタッチしたり発射ボタンを押すことで光が出てくる。画面のオブジェクトごとに光を扱う性質が違うため、そこがパズル要素となり、赤い光を織姫に届けるとゲームクリア。

## 推しポイント
ここにはプロダクトの推しポイントを書きます。
なぜそのプロダクトはほかのプロダクトより優れているのでしょうか？他のプロダクトにはない特徴は何でしょうか？ほかでもないそのプロダクトによってユーザーはどのような嬉しさを得ますか？

パズルを解けた時の爽快感と、光のグラフィックに力を入れています。視覚や達成感から嬉しさを得ることができます。
...
ゆうげつ:リーダー、メインシステム、発表(予定)
Uma:ライティング、パーティクルエフェクト、3Dオブジェクトモデリング、発表資料作成
ドクちゃん:3Dオブジェクトモデリング、UIデザイン、画面デザイン
みかんのすけ:サウンド、ステージデザイン、3Dオブジェクトモデリング

### 開発における工夫した点
開発における工夫した点を書いてください。チーム開発における工夫、技術的な工夫、スケジュール管理の工夫など、どのようなことでもよいです。

ディスコードで素材を送るにあたって、フォーラムを使用してタグをつけることでカテゴリごとに素材を管理しやすくしました。
同様に、アイデアやリファレンスもわかりやすくまとめることができたと思います。
